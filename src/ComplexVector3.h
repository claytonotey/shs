...
inline ComplexVector3 expandCoords(Vector3 &vx, Vector3 &zz, const Complex &x, const Complex &y, const Complex &z) {
  ComplexVector3 r;
  Vector3 vy = zz * vx;
...
inline ComplexVector3 expandCoords(Vector3 &vx, Vector3 &zz, const Complex &x, const Complex &y) {
  ComplexVector3 r;
  Vector3 vy = zz * vx;
  r.x = x*vx.x + y*vy.x;
  r.y = x*vx.y + y*vy.y;
