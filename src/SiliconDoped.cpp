...
SiliconDoped :: SiliconDoped(SiliconDopedType type, Real N) : type(type), N(N) {}

Complex SiliconDoped :: eps(Real eV)
{
  Real omega = eV * SI::eV / SI::hbar;
  if(type == SiliconDopedN) {
    Real mu1 = .00685;
    Real mumax = .1414;
    Real mu2 = .00561;
    Real Cr = 9.20e22;
