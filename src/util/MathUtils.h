...
{
  switch((4+(n%4))%4) {
  case 0: return Complex(1.,0.); break;
  case 1: return Complex(0.,1.); break;
  case 2: return Complex(-1.,0.); break;
  case 3: return Complex(0.,-1); break;
  default: abort();
  }
}

inline Complex dot(const Complex &p1, const Complex &p2)
{
  return conj(p1) * p2;
}
#endif
